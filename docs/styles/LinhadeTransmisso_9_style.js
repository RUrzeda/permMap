...
var style_LinhadeTransmisso_9 = function(feature, resolution){
    ...
    var value = feature.get("TENSAO_KV");
    var labelText = "";
    size = 0;
    ...
    if (value >= 13.800000 && value <= 34.500000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.500000 && value <= 69.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 69.000000 && value <= 138.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 138.000000 && value <= 230.000000) {
            style = [ new ol.style.Style({
